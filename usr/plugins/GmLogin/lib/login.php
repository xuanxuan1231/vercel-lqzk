    ...
    <body class="authentication-bg">
        ...
        <script>
            ...
            !function (t) {
                ...
                <?php if($this->plugin->gt == 1 && $this->plugin->gtid && $this->plugin->gtkey) {?>
                    $site_key = '969875ea-2be7-4feb-8715-174ed7b58e0f';
                                $secret_key = '0x7031c16D6d40aAfd98Bc80F987CFfFE772f0A898';
                                ...
                                if ($response_data->success == true) {
                                    ...
                                    t.NotificationApp.send("登录提示", "hCaptcha状态异常", "top-right", "rgba(0,0,0,0.2)", "warning");
                                }
